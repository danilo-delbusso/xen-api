...
<https://docs.xenserver.com/en-us/xenserver/8/developer/sdk-guideocaml/sdk-gen/powershell/autogen/README_51.md>
...
3. Open a PowerShell 5 prompt as administrator.

    To do this, open the Windows Start menu by clicking the Start icon, find
    the item PowerShell 5, right click it and select Run as administrator.
...
6. Open a PowerShell 5 prompt as a regular user (click Start > PowerShell)
